...
inherit autotools bash-completion-r1 check-reqs flag-o-matic java-pkg-opt-2 multiprocessing python-single-r1 qmake-utils toolchain-funcs xdg-utils eapi8-dosym
...
PATCHES=(
	...
	"${FILESDIR}/funtoo-20230516.patch"
